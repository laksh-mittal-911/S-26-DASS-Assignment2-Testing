"""Property module – defines the Property and PropertyGroup classes."""
...
class PropertyGroup:
    """Represents a collection of properties sharing a color."""
